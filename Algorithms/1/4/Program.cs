...
namespace _4
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Time for original array in miliseconds: " + (Environment.TickCount - original));
            Console.WriteLine();
            ...
            Console.WriteLine("Time for even numbers sort in miliseconds: " + (Environment.TickCount - even));
            Console.WriteLine();
            ...
            Console.WriteLine("Time for odd numbers sort in miliseconds: " + (Environment.TickCount - odd));
            Console.WriteLine();
