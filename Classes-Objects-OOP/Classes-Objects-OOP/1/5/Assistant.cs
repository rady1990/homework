...
namespace _5
{
    class Assistant : Lecturer
    {
        ...
        public Assistant(string firstName, string familyName, int workingExperience, string teachUniversity, bool chiefAssistant)
            : base(firstName, familyName, workingExperience, teachUniversity)
        {
